...
var never = '<iframe src="https://streamable.com/e/rb2bk8?autoplay=1" frameborder="0" width="98%" height="720px" allowfullscreen allow="autoplay" style="width:98%;height:720px;overflow:hidden;"></iframe>'
var key = "";
...
window.addEventListener('keydown', function (event)
{
    ...
    {
        document.getElementsByClassName("VideoPresentation")[0].innerHTML = never;
...
function LoopScroll() {         //  create a loop function
    setTimeout(function() {   
        k=j;
        j++;          
      console.log("j=" + j)          //  increment the counter
...
function meteo()
{
    navigator.geolocation.getCurrentPosition(function(position) {
        ...
        var url = "http://api.openweathermap.org/data/2.5/weather?lat=" + position.coords.latitude + "&lon=" + position.coords.longitude + "&units=metric&APPID=" + API_KEY
...
console.log("Tien mais que fait tu ici ?");
